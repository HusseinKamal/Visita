...
public class OrderGuestAdapter extends RecyclerView.Adapter<OrderGuestAdapter.MyViewHolder>{
    ...
    public OrderGuestAdapter(Context mContext,ArrayList<Request> listRequest) {
        this.mContext = mContext;
        this.listRequest=listRequest;
    }
    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_order_layout, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        try {
            ...
            //photo
            if(ValidateData.isValid(item.getEmployeePhoto()))
            {
                Picasso.with(mContext).load(item.getEmployeePhoto()).placeholder(R.drawable.ic_girl).into(holder.profileImage);
            }
            else
            {
            ...
            //name
            holder.tvUser.setText(item.getEmployeeName());
            //job
            holder.tvJob.setText(item.getEmployeeJob());
            //time
            ...
            holder.card.setOnClickListener(view -> {
                try {
                    Intent objIntent = new Intent(mContext, RequestDetailsGuestActivity.class);
