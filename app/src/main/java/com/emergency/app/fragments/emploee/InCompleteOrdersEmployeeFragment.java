...
import com.emergency.app.databinding.FragmentInCompleteOrdersEmployeeBinding;
...
public class InCompleteOrdersEmployeeFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    FragmentInCompleteOrdersEmployeeBinding bind;
    ...
    public InCompleteOrdersEmployeeFragment() {
        // Required empty public constructor
    }
    public static InCompleteOrdersEmployeeFragment newInstance() {
        InCompleteOrdersEmployeeFragment fragment = new InCompleteOrdersEmployeeFragment();
        return fragment;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        bind = DataBindingUtil.inflate(inflater, R.layout.fragment_in_complete_orders_employee, container, false);
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if(!isGetData) {
                        for (DataSnapshot uniqueKeySnapshot : dataSnapshot.getChildren()) {
                            ...
                            if (Integer.parseInt(String.valueOf(uniqueKeySnapshot.child(AppConfigHelper.EMPLOYEE_ID_FIELD).getValue())) == user.getId() &&(!reqStatus.equals(AppConfigHelper.FINISH_STATUS) &&!reqStatus.equals(AppConfigHelper.REJECT_STATUS))) {
