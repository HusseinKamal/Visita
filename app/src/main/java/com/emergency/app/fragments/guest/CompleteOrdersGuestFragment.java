...
import com.emergency.app.databinding.FragmentCompleteOrdersGuestBinding;
...
public class CompleteOrdersGuestFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {

    FragmentCompleteOrdersGuestBinding bind;
    ...
    public static CompleteOrdersGuestFragment newInstance() {
        return new CompleteOrdersGuestFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        bind = DataBindingUtil.inflate(inflater, R.layout.fragment_complete_orders_guest, container, false);
                    ...
                    if(!isGetData) {
                        for (DataSnapshot uniqueKeySnapshot : dataSnapshot.getChildren()) {
                            if (Integer.parseInt(String.valueOf(uniqueKeySnapshot.child(AppConfigHelper.GUEST_ID_FIELD).getValue())) == user.getId()
                                ...
                                int employeeId = Integer.parseInt(String.valueOf(uniqueKeySnapshot.child(AppConfigHelper.EMPLOYEE_ID_FIELD).getValue()));
                                ...
                                Request objData = new Request(id, requestType, address, guestType, desc, report, dateTime, status, mobile, job, employeeName, guestName, employeePhoto, guestPhoto, guestID, employeeId, price);
